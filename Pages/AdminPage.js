class AdminPage {
    ...
    async criarConvidadoTeste(nome, email, telefone) {
        ...
        await this.page.locator('a[ic-include*="novo_convidado"]').filter({ hasText: 'Convidado', visible: true }).click();
        // Preenche os dados
    ...
    async aprovarConvidado(idEvento, nomeConvidado) {
        // 1. Vai para a home
        await this.page.goto('https://app.codemyparty.com.br/home/');
        // 2. O PULO DO GATO: Espera a página estar totalmente carregada
        ...
        await this.page.getByText(idEvento).filter({ visible: true }).first().click();
