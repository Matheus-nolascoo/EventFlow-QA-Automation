...
(async () => {
  ...
  const linkDoConvite =
    "https://app.codemyparty.com.br/c/4377403e-fc45-4ef5-8f75-7f66f3daf568?fbclid=IwAR5QOXjM6qOxeWmrHmikklusefvUf12U-RjjIOrMpZoaTiUxwSprdSL3rb3jCg_wapm_ODVkYzBmMTAtMDc2Yi00NWQyLWE0OWUtNTBmMmU2NzU5NDQ1_waaem_4gNHC1Z0xfpU8HGNosc2HA";
  ...
  await page.screenshot({
    path: `${pastaPrintsTestes}/pagina_de_confirmacao.png`,
    fullPage: true,
  });
  ...
  await page
    ...
    .setInputFiles("./Foto_de_Teste.jpeg");
  ...
  // A opção fullPage: true garante que o print pegue a tela toda e fique bonito para o cliente
  await page.screenshot({
    path: `${pastaPrintsTestes}/dados_enviados.png`,
    fullPage: true,
  });
