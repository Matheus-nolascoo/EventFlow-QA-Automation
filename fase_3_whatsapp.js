    ...
    console.log('⏳ Aguardando a barra de pesquisa carregar (Escaneie o QR Code se for a 1ª vez!)...');
    // Espera até a barra de pesquisa de conversas aparecer
    await page.waitForSelector('input[aria-label="Pesquisar ou começar uma nova conversa"]', { timeout: 60000 }); 
    ...
    const bolhaMensagem = painelChat.locator('div[role="row"]', { hasText: 'Confirmar Presença' }).last();
    ...
    await bolhaMensagem.screenshot({ path: `${pastaPrintsTestes}/convite_whatsapp.png` });
    // --- FIM DA CORREÇÃO ---
    ...
    console.log('🧹 Clicando em "Não" para fechar o pop-up e manter a casa limpa...');
